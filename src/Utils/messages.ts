...
export const instructionsTraining = `Create a new flashcard and add it to the group. You can have as many as flashcards as you want!

You need to input the kanji 「漢字」, the hiragana reading 「ひらがな」 and the meaning of the kanji.

Click the 「next/show」 button to start the training. The kanjis will show in random order.
